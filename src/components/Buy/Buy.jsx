...
function BuyFormModal({ onClose, product, setProduct }) {
...
product && (
  <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75 z-50">
      <div className="bg-white p-8 rounded-lg shadow-lg w-96">
        <h2 className="text-xl font-semibold mb-4">Buy Form</h2>
            ...
            <div>
              <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                <div className="lg:col-start-2">
                  <h3 className="text-2xl font-bold tracking-tight sm:text-3xl text-gray-50">Product Description and details</h3>
...
{isModalOpen && <BuyFormModal onClose={closeModal} product={product} setProduct={setProduct} />}
</>
  )
}
